<x-layout>
    ...
    <section id="starter-section" class="starter-section section">
        <div class="container loginbox displayFixer py-3">
            <div class="col-12 col-sm-8 col-lg-5 mx-auto p-3 loginformContainer" id="loginContainer">
                <div class="d-flex justify-content-center mb-3">
                    <a href="{{ route('studentlogin') }}" class="btn mx-1 role-btn"
                        data-role="student">Student</a>
                    <a href="{{ route('teacherlogin') }}" class="btn mx-1 role-btn"
                        data-role="teacher">Teacher</a>
                    <a href="{{ route('adminlogin') }}" class="btn mx-1 role-btn active" data-role="admin">Admin</a>
                </div>
                <h2 class="text-center" id="loginTitle">Admin Login</h2>
