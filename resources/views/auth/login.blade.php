        ...
        <div class="container loginbox displayFixer py-3">
            <div class="col-12 col-sm-8 col-lg-5 mx-auto p-3 loginformContainer student-theme" id="loginContainer">
                <div class="d-flex justify-content-center mb-3">
                    <button type="button" class="btn mx-1 role-btn active"
                        data-role="student">Student</button>
                    <button type="button" class="btn mx-1 role-btn"
                        data-role="teacher">Teacher</button>
                    <button type="button" class="btn mx-1 role-btn" data-role="admin">Admin</button>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        roleBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                loginTitle.textContent = themes[role].title;
                loginContainer.className =
                    'col-12 col-sm-8 col-lg-5 mx-auto p-3 loginformContainer ' + themes[role].class;
