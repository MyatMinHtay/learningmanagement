...
Route::prefix('online-learning-platform')->group(function () {
    ...
    Route::middleware('guest')->group(function () {
        ...
        Route::get('/studentlogin', [AuthController::class, 'login'])->name('studentlogin');
        Route::get('/adminlogin', [AuthController::class, 'adminlogin'])->name('adminlogin');
        Route::get('/teacherlogin',[AuthController::class,'teacherlogin'])->name('teacherlogin');
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Course Enrollment
        Route::post('/courses/{course}/enroll', [CourseController::class, 'enrollJson'])->name('courses.enroll');
    ...
    Route::middleware(['auth', 'admincheck:users'])->group(function () {
        ...
        Route::get('/students/{student}/courses', [CourseController::class, 'showStudentCourses'])->name('student.courses');
        ...
        Route::prefix('admin/users')->middleware('admincheck:admins')->group(function () {
            ...
            Route::post('/create', [UserController::class, 'createuser'])->middleware('admincheck:roles')->name('admin.users.create');
            ...
            Route::get('/edit/{user:username}', [UserController::class, 'edituser'])->middleware('admincheck:roles')->where('username', '[A-Za-z0-9_\-]+')->name('admin.users.edit');
            Route::get('/lock/{user:username}', [UserController::class, 'lockuser'])->middleware('admincheck:roles')->where('username', '[A-Za-z0-9_\-]+')->name('admin.users.lock');
            Route::get('/unlock/{user:username}', [UserController::class, 'unlockuser'])->middleware('admincheck:roles')->where('username', '[A-Za-z0-9_\-]+')->name('admin.users.unlock');
            Route::get('/delete/{user:username}', [UserController::class, 'deleteuser'])->middleware('admincheck:roles')->where('username', '[A-Za-z0-9_\-]+')->name('admin.users.delete');
        });
        
        // System Roles Management
        Route::prefix('admin/roles')->middleware('admincheck:roles')->group(function () {
            Route::get('/', [SystemRoleController::class, 'index'])->name('admin.roles.index');
            Route::post('/create', [SystemRoleController::class, 'createrole'])->name('admin.roles.create');
            Route::post('/update/{role:role}', [SystemRoleController::class, 'updaterole'])->where('role', '[A-z\d\-_]+')->name('admin.roles.update');
            Route::get('/edit/{role:role}', [SystemRoleController::class, 'editrole'])->where('role', '[A-z\d\-_]+')->name('admin.roles.edit');
            Route::get('/delete/{role:role}', [SystemRoleController::class, 'deleterole'])->where('role', '[A-z\d\-_]+')->name('admin.roles.delete');
        });
